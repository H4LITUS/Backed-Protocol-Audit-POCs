...
contract NFTLoansTicketDescriptor {
    ...
    ITicketTypeSpecificSVGHelper public immutable svgHelper;
     ...
     */
    function uri(NFTLoanFacilitator nftLoanFacilitator, uint256 id) external view returns (string memory) {
     ...
     */
    function generateDescriptor(NFTLoanTicketSVG.SVGParams memory svgParams) private view returns (string memory) {
