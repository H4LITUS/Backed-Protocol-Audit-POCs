...
library NFTLoanTicketSVG {
        ...
        returns (string memory svg)
    {
        return string.concat(
            ...
            stylesAndBackground(typeSpecificHelper, params.id, params.loanAssetContract, params.collateralContract),
    ...
    function dynamicValues2(SVGParams memory params) private pure returns (string memory) {
        return string.concat(
